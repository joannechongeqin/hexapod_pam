...
yuna.rotx_trans_body(10, 0.02, 0.02, 0, move=True)
print("translated body and rotated body 10 deg") 

# leg1away_w = np.zeros((3,6))
# leg1away_w[:, 0] = [0, -0.1, 0]
# leg1wall_w = np.zeros((3,6))
# leg1wall_w[:, 0] = [0, 0.1, 0.1]
